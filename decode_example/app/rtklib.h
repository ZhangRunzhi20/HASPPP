...
#define EFACT_GAL   0.9                 /* error factor: Galileo */
...
#define MAXDTOE_CMP 7200.0             /* max time difference to BeiDou Toe (s) */
...
#define BDS_EPH_NONE  0x00
#define BDS_EPH_B1C   0x01
#define BDS_EPH_B2b   0x02
#define BDS_EPH_B2a   0x04
#define BDS_EPH_B2I   0x08
#define BDS_EPH_B1I   0x10
#define BDS_EPH_B3I   0x20
...
typedef struct {
    ...
    int iodssr;         /* */
    int nsat;           /* */
    b2bsatp_t sat[MAXSAT];  /* */
} b2bsat_t;

typedef struct {        /* b2b message type */
    int week,tow;       /* receiption time */
    int prn;            /* b2b satellite PRN number */
    unsigned char msg[61]; /* b2b message (486bit) padded by 0 */
} b2bmsg_t;

typedef struct {        /* b2b message type */
    int n,nmax;         /* number of b2b messages/allocated */
    b2bmsg_t *msgs;     /* b2b messages */
} b2b_t;
...
EXPORT void eph2ek(gtime_t time,const eph_t *eph,double *relA,double *ek);
...
EXPORT void satantoff(gtime_t time, const double *rs, int sat, const nav_t *nav,
                      double *dant);
EXPORT int  satpos(gtime_t time, gtime_t teph, int sat, int ephopt,int bdsephsource,
