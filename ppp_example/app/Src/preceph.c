                      ...
                      double *dant)
{
    ...
    double C1,C2,C3,C4,dant1,dant2,dant3;
    int i,sys;
    ...
    C3= SQR(freq[0])/(SQR(freq[0])-SQR(freq[2]));
    C4=-SQR(freq[2])/(SQR(freq[0])-SQR(freq[2]));
    
    /* iono-free LC */
    for (i=0;i<3;i++) {
        dant1=pcv->off[1][0][0]*ex[i]+pcv->off[1][0][1]*ey[i]+pcv->off[1][0][2]*ez[i];
        dant2=pcv->off[1][1][0]*ex[i]+pcv->off[1][1][1]*ey[i]+pcv->off[1][1][2]*ez[i];
        dant3=pcv->off[1][2][0]*ex[i]+pcv->off[1][2][1]*ey[i]+pcv->off[1][2][2]*ez[i];
        dant[i]=(C1*dant1+C3*dant3)-(C1*dant1+C2*dant2);
    }
}
                    ...
                    double *rs, double *dts, double *var)
{
    ...
    pephclk(time,sat,nav,dtss,NULL);
    time = timeadd(time,-dtss[0]);
    dtss[0] = 0;
    ...
    cross3(ea,ec,er);
    trace(1,"#Pre: %s,%3d,%10.10f,%10.10f,%10.10f,%6.10f,%6.10f,%6.10f,%6.10f,%6.10f,%6.10f,%6.10f,%6.10f,%6.10f,%6.10f,\n",
